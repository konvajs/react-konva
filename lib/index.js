...
var REACT_VERSION = '16.6.0';

if (React.version !== REACT_VERSION) {
  console.error('Version mismatch detected for react-konva and react. react-konva expects to have react version ' + REACT_VERSION + ', but it has version ' + React.version + '. Make sure versions are matched, otherwise, react-konva work is not guaranteed.');
}
